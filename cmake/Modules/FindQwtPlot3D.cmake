...
find_path( QT_QWTPLOT3D_INCLUDE_DIR qwt3d_plot.h /usr/include/ /usr/local/include /usr/include/qwtplot3d/ /usr/include/qwtplot3d-qt5/ /usr/local/include/qwtplot3d-qt5 )

#message( STATUS "${QWTPLOT3D_INCLUDE_DIR}")
find_library( QWTPLOT3D_LIBRARIES NAMES qwtplot3d-qt5 qwtplot3d /usr/lib/ usr/local/lib )
...
if ( QWTPLOT3D_FOUND )
  if ( NOT QWTPLOT3D_FIND_QUIETLY )
    message( STATUS "Found QwtPlot3D-qt5: ${QWTPLOT3D_LIBRARIES}")
  endif( NOT QWTPLOT3D_FIND_QUIETLY )
else( QWTPLOT3D_FOUND )
  if ( QWTPLOT3D_FIND_REQUIRED )
    message(FATAL_ERROR "Could not find QwtPlot3D-qt5 ")
